        ...
        })(
          {
            ...
            1: [
              function (e, t, n) {
                (function () {
                    ...
                    N.forEach =
                      function (e, t, n) {
                        ...
                        if (p && e.forEach === p) e.forEach(t, n);
                          ...
                          for (var o in e)
                            if (N.has(e, o) && t.call(n, e[o], o, e) === i)
                              return;
                      });
                  ...
                  var P = {
                    escape: new RegExp(
                      "[" + N.keys(D.escape).join("") + "]",
                      "g"
                    ),
                    unescape: new RegExp(
                      "(" + N.keys(D.unescape).join("|") + ")",
                      "g"
                    ),
                  };
                    ...
                    (N.mixin = function (e) {
                      C(N.functions(e), function (t) {
                        ...
                        N.prototype[t] = function () {
                          var e = [this._wrapped];
                          return (
                            a.apply(e, arguments), I.call(this, n.apply(N, e))
                          );
                        };
                      });
                    });
            ...
            3: [
              function (e, t, n) {
                (n.reservedVars = { arguments: !1, NaN: !1 }),
                  ...
                  (n.phantom = { phantom: !0, require: !0, WebPage: !0 }),
                  (n.rhino = {
                    defineClass: !1,
                    deserialize: !1,
                    gc: !1,
            ...
            n4bKNg: [
              function (e, t, n) {
                var r = e("underscore"),
                  i = e("events"),
                  s = e("../shared/vars.js"),
                  o = e("../shared/messages.js"),
                  u = e("./lex.js").Lexer,
                  a = e("./reg.js"),
                  f = e("./state.js").state,
                  l = e("./style.js"),
                  c = e("console-browserify"),
                  h = (function () {
                    function e(e, t) {
                      return (
                        (e = e.trim()),
                    ...
                    function d(e, t) {
                      var n;
                      for (n in t)
                        r.has(t, n) && !r.has(h.blacklist, n) && (e[n] = t[n]);
                    }
                    function v() {
                    ...
                    function m() {
                      f.option.couch && d($t, s.couch),
                        f.option.rhino && d($t, s.rhino),
                        f.option.shelljs && (d($t, s.shelljs), d($t, s.node)),
                        f.option.phantom && d($t, s.phantom),
                        f.option.prototypejs && d($t, s.prototypejs),
                        f.option.node && d($t, s.node),
                        f.option.devel && d($t, s.devel),
                        f.option.dojo && d($t, s.dojo),
                        f.option.browser && d($t, s.browser),
                        f.option.nonstandard && d($t, s.nonstandard),
                        f.option.jquery && d($t, s.jquery),
                        f.option.mootools && d($t, s.mootools),
                        f.option.worker && d($t, s.worker),
                        f.option.wsh && d($t, s.wsh),
                        f.option.globalstrict &&
                          f.option.strict !== !1 &&
                          (f.option.strict = !0),
                        f.option.yui && d($t, s.yui),
                    ...
                    function b(e, t, n, r, i, s) {
                      ...
                      return (
                        ...
                        (l.reason = p(c.desc, l)),
                        h.errors.push(l),
                        f.option.passfail && g("E042", a, u),
                        (Yt += 1),
                        Yt >= f.option.maxerr && g("E043", a, u),
                        l
                      );
                    }
                      ...
                      t === "exception" &&
                        ...
                        r.has(Bt, e) &&
                          ...
                          (Bt[e] === !0
                            ? f.option.latedef &&
                              ((f.option.latedef === !0 &&
                                r.contains([Bt[e], t], "unction")) ||
                                !r.contains([Bt[e], t], "unction")) &&
                              b("W003", f.tokens.next, e)
                            : ((!f.option.shadow && t !== "exception") ||
                                Bt["(blockscope)"].getlabel(e)) &&
                              b("W004", f.tokens.next, e)),
                        Bt["(blockscope)"] &&
                          Bt["(blockscope)"].current.has(e) &&
                          E("E044", f.tokens.next, e),
                        i
                          ? Bt["(blockscope)"].current.add(e, t, f.tokens.curr)
                          : ((Bt[e] = t),
                            n && (Bt["(tokens)"][e] = n),
                            Bt["(global)"]
                              ? ((Ft[e] = Bt),
                        ...
                        n.forEach(function (n) {
                          ...
                          if (o.indexOf(r) >= 0) {
                            if (i !== "false") {
                              ...
                              r === "indent" &&
                                (f.option["(explicitIndent)"] = !0),
                                (f.option[r] = i);
                            } else
                              r === "indent"
                                ? (f.option["(explicitIndent)"] = !1)
                                : (f.option[r] = !1);
                            return;
                          }
                          if (r === "validthis") {
                    ...
                    function k(e, t) {
                      ...
                      for (;;) {
                        (f.tokens.next = Ut.shift() || zt.token()),
                          f.tokens.next || g("E041", f.tokens.curr.line);
                        if (
                          f.tokens.next.id === "(end)" ||
                    ...
                    function O(e, t) {
                      ...
                      !t &&
                        ...
                        C(0).value === "(" &&
                        (f.option.inMoz(!0) ||
                          b("W118", f.tokens.next, "let expressions"),
                        (s = !0),
                        Bt["(blockscope)"].stack(),
                        k("let"),
                        k("("),
                      ...
                      if (t === !0 && f.tokens.curr.fud)
                        ...
                        f.tokens.curr.nud
                          ? (n = f.tokens.curr.nud())
                          : E("E030", f.tokens.curr, f.tokens.curr.id);
                    ...
                    function _(e, t) {
                      (e = e || f.tokens.curr),
                        (t = t || f.tokens.next),
                        f.option.white &&
                          (e.character !== t.from || e.line !== t.line) &&
                          b("W012", t, t.value);
                    }
                    function D(e, t) {
                      (e = e || f.tokens.curr),
                    ...
                    function H(e, t) {
                      (e = e || f.tokens.curr),
                        (t = t || f.tokens.next),
                        !f.option.laxbreak && e.line !== t.line
                          ? b("W014", t, t.value)
                          : f.option.white &&
                            ((e = e || f.tokens.curr),
                            (t = t || f.tokens.next),
                    ...
                    function B(e) {
                      if (!f.option.white && !f.option["(explicitIndent)"])
                        return;
                      if (f.tokens.next.id === "(end)") return;
                      var t = Rt + (e || 0);
                      f.tokens.next.from !== t &&
                        b(
                          "W015",
                          f.tokens.next,
                          f.tokens.next.value,
                    ...
                    function j(e) {
                      (e = e || f.tokens.curr),
                        e.line !== f.tokens.next.line && b("E022", e, e.value);
                    }
                    function F(e, t) {
                      e.line !== t.line
                        ? f.option.laxcomma ||
                          (I.first && (b("I001"), (I.first = !1)),
                          b("W014", e, t.value))
                        : !e.comment &&
                          e.character !== t.from &&
                          f.option.white &&
                    ...
                    function I(e) {
                      (e = e || {}),
                        e.peek
                          ? F(f.tokens.prev, f.tokens.curr)
                          : (F(f.tokens.curr, f.tokens.next), k(",")),
                        f.tokens.next.value !== "]" &&
                          f.tokens.next.value !== "}" &&
                          P(f.tokens.curr, f.tokens.next);
                      if (
                        ...
                        switch (f.tokens.next.value) {
                          ...
                          case "with":
                            return (
                              E("E024", f.tokens.next, f.tokens.next.value), !1
                            );
                        }
                    ...
                    function Q(e, t, n, r) {
                      ...
                      return (
                        ...
                        (i.led = function (i) {
                          return (
                            r ||
                              (H(f.tokens.prev, f.tokens.curr),
                              P(f.tokens.curr, f.tokens.next)),
                            e === "in" && i.id === "!" && b("W018", i, "!"),
                            typeof t == "function"
                              ? t(i, this)
                              : ((this.left = i), (this.right = O(n)), this)
                          );
                        }),
                        i
                      );
                        ...
                        typeof t == "function"
                          ...
                          : function (e, t) {
                              ...
                              if (e) {
                                ...
                                if (e.identifier && !c(e))
                                  return (
                                    Bt[e.value] === "exception" && b("W022", e),
                                    (t.right = O(10)),
                                    t
                                  );
                                e === f.syntax["function"] &&
                                  b("W023", f.tokens.curr);
                              }
                              E("E031", t);
                            },
                        n
                    ...
                    function it(e, t) {
                      ...
                      return c(n)
                        ? t && f.option.inES5()
                          ...
                          ? r
                          : (t &&
                              !kt.getCache("displayed:I002") &&
                              (kt.setCache("displayed:I002", !0), b("I002")),
                            b("W024", f.tokens.curr, f.tokens.curr.id),
                            r)
                        : r;
                    }
                    function st(e, t) {
                    ...
                    function ut(e) {
                      ...
                      u &&
                        o.meta &&
                        o.meta.isFutureReservedWord &&
                        C().id === ":" &&
                        (b("W024", o, o.id), (u = !1));
                      if (r.has(["[", "{"], o.value) && on().isDestAssign) {
                        f.option.inESNext() ||
                          b("W104", f.tokens.curr, "destructuring expression"),
                          (t = wt()),
                      ...
                      while (
                        ...
                        f.tokens.next.id === ";"
                          ? ((n = C()),
                            (!n || (n.id !== "(" && n.id !== "[")) && b("W032"),
                            k(";"))
                          : t.push(ut(e === f.tokens.next.line));
                      return t;
                    }
                    function ft() {
                      var e, t, n;
                        ...
                        if (f.tokens.next.id === "(string)") {
                          ...
                          B(),
                            ...
                            f.directive[f.tokens.curr.value] &&
                              b("W034", f.tokens.curr, f.tokens.curr.value),
                    ...
                    function lt(e, t, n, i) {
                      ...
                      if (f.tokens.next.id === "{") {
                        ...
                        if (f.tokens.next.id !== "}") {
                          Rt += f.option.indent;
                          while (!e && f.tokens.next.from > Rt)
                            Rt += f.option.indent;
                          if (n) {
                            a = {};
                            for (p in f.directive)
                              r.has(f.directive, p) && (a[p] = f.directive[p]);
                            ft(),
                              f.option.strict &&
                                Bt["(context)"]["(global)"] &&
                                !a["use strict"] &&
                        ...
                        if (n) {
                          ...
                          E("E021", f.tokens.next, "{", f.tokens.next.value);
                      } else
                        (Bt["(nolet)"] = !0),
                          (!t || f.option.curly) &&
                          ...
                          (Vt = !0),
                          (Rt += f.option.indent),
                          (s = [ut(f.tokens.next.line === f.tokens.curr.line)]),
                          (Rt -= f.option.indent),
                          (Vt = !1),
                          delete Bt["(nolet)"];
                      Bt["(verb)"] = null;
                    ...
                    function ct(e) {
                      Xt &&
                        typeof Xt[e] != "boolean" &&
                        b("W036", f.tokens.curr, e),
                        typeof Wt[e] == "number" ? (Wt[e] += 1) : (Wt[e] = 1);
                    }
                    function ht(e) {
                      var t = e.value,
                        n = e.line,
                    ...
                    function pt() {
                      ...
                      return (
                        ...
                        f.tokens.next.value === "each" &&
                          (k("each"),
                          f.option.inMoz(!0) ||
                            b("W118", f.tokens.curr, "for each")),
                        k("("),
                        Bt["(comparray)"].setState("define"),
                        (e.left = O(10)),
                        k(")"),
                        f.tokens.next.value === "if" &&
                          (k("if"),
                          k("("),
                          Bt["(comparray)"].setState("filter"),
                          (e.filter = O(10)),
                          k(")")),
                        k("]"),
                        Bt["(comparray)"].unstack(),
                        e
                      );
                    }
                    function dt() {
                        ...
                        e ||
                          (f.tokens.next.id === "(string)"
                            ...
                            : f.tokens.next.id === "(number)" &&
                              ((e = f.tokens.next.value.toString()), k())),
                          ...
                          for (var l in e) {
                            ...
                            if (r.contains(["{", "["], t.id))
                              for (u in t.left)
                                (u = o[u]),
                                  u.id &&
                                    (i.push(u.id), T(u.id, "unused", u.token));
                            else {
                              if (t.value === "...") {
                                f.option.inESNext() ||
                                  b("W104", t, "spread/rest operator");
                                continue;
                              }
                              T(t.value, "unused", t);
                            }
                        ...
                        if (r.contains(["{", "["], f.tokens.next.id)) {
                          ...
                          f.tokens.next.value === "..."
                            ? (f.option.inESNext() ||
                              ...
                              (s = st(!0)),
                              i.push(s),
                              T(s, "unused", f.tokens.curr))
                            : ((s = st(!0)),
                              i.push(s),
                              T(s, "unused", f.tokens.curr));
                        a &&
                          f.tokens.next.id !== "=" &&
                          E("E051", f.tokens.current),
                          f.tokens.next.id === "=" &&
                            (f.option.inESNext() ||
                              b("W119", f.tokens.next, "default parameters"),
                            k("="),
                            (a = !0),
                            O(10));
                        if (f.tokens.next.id !== ",")
                          return k(")", n), D(f.tokens.prev, f.tokens.curr), i;
                        I();
                      }
                    }
                    function mt(e, t, n, r) {
                      ...
                      return (
                        ...
                        n && (Bt["(generator)"] = !0),
                        (i = Bt),
                        (f.tokens.curr.funct = Bt),
                        jt.push(Bt),
                        e && T(e, "function"),
                        (Bt["(params)"] = vt(r)),
                        Bt["(metrics)"].verifyMaxParametersPerFunction(
                          Bt["(params)"]
                        ),
                        lt(!1, !0, !0, r ? !0 : !1),
                        n &&
                          Bt["(generator)"] !== "yielded" &&
                          E("E047", f.tokens.curr),
                        Bt["(metrics)"].verifyMaxStatementsPerFunction(),
                        Bt["(metrics)"].verifyMaxComplexityPerFunction(),
                        (Bt["(unusedOption)"] = f.option.unused),
                        (Jt = u),
                        (f.option = s),
                        (f.ignored = o),
                        (Bt["(last)"] = f.tokens.curr.line),
                        (Bt["(lastcharacter)"] = f.tokens.curr.character),
                        (Bt = Bt["(context)"]),
                        i
                      );
                    }
                    function gt(e) {
                      return {
                        ...
                        verifyMaxParametersPerFunction(t) {
                          (t = t || []),
                            f.option.maxparams &&
                    ...
                    function wt() {
                      ...
                      var i = function () {
                        ...
                        if (r.contains(["[", "{"], f.tokens.next.value)) {
                          t = wt();
                          for (var i in t)
                            (i = t[i]), n.push({ id: i.id, token: i.token });
                        } else
                          f.tokens.next.value === ","
                    ...
                    function Et(e, t) {
                      t.first &&
                        r.zip(e, t.first).forEach(function (e) {
                          var t = e[0],
                            n = e[1];
                          t && n
                            ? (t.first = n)
                            : t &&
                              t.first &&
                              !n &&
                              b("W080", t.first, t.first.value);
                        });
                    }
                    function St(e) {
                      return (
                        f.option.inESNext() ||
                          b("W104", f.tokens.curr, "class"),
                        e
                          ? ((this.name = st()),
                            T(this.name, "unused", f.tokens.curr))
                          : f.tokens.next.identifier &&
                    ...
                    function Nt() {
                      ...
                      switch (f.tokens.next.id) {
                        ...
                        case "-":
                          k("-"),
                            f.tokens.curr.character !== f.tokens.next.from &&
                              b("W011", f.tokens.curr),
                            M(f.tokens.curr, f.tokens.next),
                            k("(number)");
                          break;
                        default:
                    ...
                    V("(number)", function () {
                      ...
                      (f.syntax["(identifier)"] = {
                        ...
                        nud() {
                          ...
                          var i;
                          r.has(Bt, "(blockscope)") &&
                            (i = Bt["(blockscope)"].getlabel(e));
                          if (Bt === t || i)
                            switch (i ? i[e]["(type)"] : Bt[e]) {
                              case "unused":
                            ...
                            typeof $t[e] != "boolean" &&
                              ((Ct !== "typeof" && Ct !== "delete") ||
                                (f.tokens.next &&
                                  (f.tokens.next.value === "." ||
                                    f.tokens.next.value === "["))) &&
                              (Bt["(comparray)"].check(e) ||
                                y(Bt, "W117", f.tokens.curr, e)),
                              ht(f.tokens.curr);
                          else
                            switch (Bt[e]) {
                              case "closure":
                      ...
                      nt("|=", "assignbitor", 20),
                      nt("^=", "assignbitxor", 20),
                      nt("<<=", "assignshiftleft", 20),
                      nt(">>=", "assignshiftright", 20),
                      nt(">>>=", "assignshiftrightunsigned", 20),
                      Q(
                        ",",
                        function (e, t) {
                          var n;
                    ...
                    Q(
                      ...
                      tt("<<", "shiftleft", 120),
                      tt(">>", "shiftright", 120),
                      tt(">>>", "shiftrightunsigned", 120),
                      Q("in", "in", 120),
                      Q("instanceof", "instanceof", 120),
                      Q(
                        "+",
                        function (e, t) {
                          var n = O(130);
                      ...
                      X("~", function () {
                        return (
                          f.option.bitwise && b("W052", this, "~"), O(150), this
                        );
                      }),
                      X("...", function () {
                        return (
                          f.option.inESNext() ||
                            b("W104", this, "spread/rest operator"),
                          f.tokens.next.identifier ||
                            E("E030", f.tokens.next, f.tokens.next.value),
                          O(150),
                          this
                      ...
                      X(
                        ...
                        function () {
                          ...
                          (this.first = []),
                            t &&
                              ((Rt += f.option.indent),
                              f.tokens.next.from === Rt + f.option.indent &&
                                (Rt += f.option.indent));
                          while (f.tokens.next.id !== "(end)") {
                            while (f.tokens.next.id === ",")
                              f.option.inES5() || b("W070"), k(",");
                            if (f.tokens.next.id === "]") break;
                            t &&
                        ...
                        (e.nud = function (e) {
                          ...
                          for (;;) {
                            ...
                            if (f.tokens.next.value === "get" && C().id !== ":")
                              ...
                              f.tokens.next.value === "("
                                ? (f.option.inESNext() ||
                                    b("W104", f.tokens.curr, "concise methods"),
                                  mt(u, undefined, c))
                                : e ||
                                  (k(":"),
                                  P(f.tokens.curr, f.tokens.next),
                            ...
                            e &&
                              u === "prototype" &&
                              E("E049", f.tokens.next, "class method", u),
                              ct(u);
                            if (e) {
                              p = "";
                              continue;
                    ...
                    var nn = U("const", function (e) {
                      var t, n, i;
                      f.option.inESNext() || b("W104", f.tokens.curr, "const"),
                        (this.first = []);
                      for (;;) {
                        var s = [];
                        P(f.tokens.curr, f.tokens.next),
                          r.contains(["{", "["], f.tokens.next.value)
                            ? ((t = wt()), (i = !1))
                            : ((t = [{ id: st(), token: f.tokens.curr }]),
                              (i = !0));
                        for (var o in t)
                          (o = t[o]),
                            Bt[o.id] === "const" && b("E011", null, o.id),
                            Bt["(global)"] &&
                              $t[o.id] === !1 &&
                              b("W079", o.token, o.id),
                        ...
                        (this.first = this.first.concat(s)),
                          ...
                          f.tokens.next.id === "=" &&
                            ...
                            f.tokens.next.id === "undefined" &&
                              b("W080", f.tokens.prev, f.tokens.prev.value),
                            C(0).id === "=" &&
                              f.tokens.next.identifier &&
                    ...
                    var rn = U("var", function (e) {
                      var t, n, i;
                      Bt["(onevar)"] && f.option.onevar
                        ? b("W081")
                        : Bt["(global)"] || (Bt["(onevar)"] = !0),
                        (this.first = []);
                      for (;;) {
                        var s = [];
                        P(f.tokens.curr, f.tokens.next),
                        ...
                        for (var o in t)
                          (o = t[o]),
                            ...
                            Bt["(global)"] &&
                              ...
                              b("W079", o.token, o.id),
                            o.id &&
                              (T(o.id, "unused", o.token), s.push(o.token));
                        if (e) break;
                        (this.first = this.first.concat(s)),
                          f.tokens.next.id === "=" &&
                            (P(f.tokens.curr, f.tokens.next),
                    ...
                    var sn = U("let", function (e) {
                      ...
                      f.option.inESNext() || b("W104", f.tokens.curr, "let"),
                        f.tokens.next.value === "("
                          ? (f.option.inMoz(!0) ||
                              b("W118", f.tokens.next, "let block"),
                            k("("),
                            Bt["(blockscope)"].stack(),
                            (s = !0))
                          : Bt["(nolet)"] && E("E048", f.tokens.curr),
                        Bt["(onevar)"] && f.option.onevar
                          ? b("W081")
                          : Bt["(global)"] || (Bt["(onevar)"] = !0),
                        (this.first = []);
                      for (;;) {
                        ...
                        P(f.tokens.curr, f.tokens.next),
                          r.contains(["{", "["], f.tokens.next.value)
                            ? ((t = wt()), (n = !1))
                            : ((t = [{ id: st(), token: f.tokens.curr.value }]),
                              (n = !0));
                        for (var u in t)
                          (u = t[u]),
                            f.option.inESNext() &&
                            ...
                            u.id &&
                              !Bt["(nolet)"] &&
                              (T(u.id, "unused", u.token, !0), o.push(u.token));
                        if (e) break;
                    ...
                    (sn.exps = !0),
                      ...
                      z("function", function () {
                        ...
                        f.tokens.next.value === "*" &&
                          ...
                          f.option.inESNext(!0)
                            ? (e = !0)
                            : b("W119", f.tokens.curr, "function*")),
                          qt && b("W082", f.tokens.curr);
                        var t = st();
                        return (
                          Bt[t] === "const" && b("E011", null, t),
                          M(f.tokens.curr, f.tokens.next),
                          T(t, "unction", f.tokens.curr),
                          mt(t, { statement: !0 }, e),
                          f.tokens.next.id === "(" &&
                            f.tokens.next.line === f.tokens.curr.line &&
                            E("E039"),
                      ...
                      X("function", function () {
                        ...
                        return (
                          t || f.option.gcl
                            ...
                            : P(f.tokens.curr, f.tokens.next),
                          mt(t, undefined, e),
                          !f.option.loopfunc && Bt["(loopage)"] && b("W083"),
                          this
                        );
                      }),
                      z("if", function () {
                      ...
                      z("try", function () {
                        function e() {
                          ...
                          k("catch"),
                            ...
                            f.tokens.next.value === "if" &&
                              (f.option.inMoz(!0) ||
                                b("W118", f.tokens.curr, "catch filter"),
                              k("if"),
                              O(0)),
                            k(")"),
                            (f.tokens.curr.funct = Bt),
                        ...
                        return (
                          ...
                          f.tokens.next.id !== ";" &&
                            ...
                            (Bt[e] !== "label"
                              ...
                              : Jt[e] !== Bt && b("W091", f.tokens.next, e),
                      ...
                      (U("return", function () {
                        return (
                          this.line === f.tokens.next.line
                            ? (f.tokens.next.id === "(regexp)" && b("W092"),
                              f.tokens.next.id !== ";" &&
                                !f.tokens.next.reach &&
                                (P(f.tokens.curr, f.tokens.next),
                                (this.first = O(0)),
                      ...
                      (function (e) {
                        ...
                        X("yield", function () {
                          var e = f.tokens.prev;
                          return (
                            f.option.inESNext(!0) && !Bt["(generator)"]
                              ? E("E046", f.tokens.curr, "yield")
                              : f.option.inESNext() ||
                                b("W104", f.tokens.curr, "yield"),
                            (Bt["(generator)"] = "yielded"),
                            this.line === f.tokens.next.line ||
                            !f.option.inMoz(!0)
                              ? (f.tokens.next.id === "(regexp)" && b("W092"),
                      ...
                      J("float"),
                      J("goto"),
                      J("implements", { es5: !0, strictOnly: !0 }),
                      J("import", { es5: !0 }),
                      J("int"),
                      J("interface", { es5: !0, strictOnly: !0 }),
                      J("long"),
                      J("native"),
                      J("package", { es5: !0, strictOnly: !0 }),
                      J("private", { es5: !0, strictOnly: !0 }),
                      J("protected", { es5: !0, strictOnly: !0 }),
                      J("public", { es5: !0, strictOnly: !0 }),
                      J("short"),
                      J("static", { es5: !0, strictOnly: !0 }),
                      J("super", { es5: !0 }),
                      J("synchronized"),
                      J("throws"),
                      J("transient"),
                    ...
                    var on = function () {
                        ...
                        return {
                          ...
                          unstack() {
                            s.variables.filter(function (e) {
                              e.unused && b("W098", e.token, e.value),
                                e.undef && y(e.funct, "W117", e.token, e.value);
                            }),
                              i.splice(i[i.length - 1], 1),
                              (s = i[i.length - 1]);
                          },
                          setState(e) {
                            r.contains(["use", "define", "filter"], e) &&
                              (s.mode = e);
                          },
                          check(n) {
                            return s && s.mode === "use"
                              ...
                              ? (e(n) ||
                                ...
                                !0)
                              : s && s.mode === "filter"
                              ? (t(n) && y(Bt, "W117", f.tokens.curr, n), !0)
                              : !1;
                          },
                        };
                      },
                      ...
                      fn = function (n, i, o) {
                        ...
                        try {
                          ...
                          var T = function (e, t) {
                            ...
                            N = function (e, t) {
                              if (!It[e]) return;
                              var n = [];
                              for (var r = 0; r < It[e].length; r += 1)
                                It[e][r] !== t && n.push(It[e][r]);
                            ...
                            C = function (e, t, n, r) {
                              ...
                              r &&
                                ...
                                o[r].indexOf(n) !== -1 &&
                                w("W098", i, s, e),
                                Qt.push({ name: e, line: i, character: s });
                            },
                            L = function (e, t) {
                              var n = e[t],
                                i = e["(tokens)"][t];
                          ...
                          for (l = 0; l < h.undefs.length; l += 1)
                            (c = h.undefs[l].slice(0)),
                              T(c[2].value, c[0])
                                ? N(c[2].value, c[2].line)
                                : f.option.undef && b.apply(b, c.slice(1));
                          ...
                          for (var A in Dt)
                            r.has(Dt, A) && !r.has(Ft, A) && C(A, Dt[A], "var");
                        } catch (O) {
                        ...
                        if (h.scope === "(main)") {
                          i = i || {};
                          for (l = 0; l < h.internals.length; l += 1)
                            (c = h.internals[l]),
                              (i.scope = c.elem),
                              fn(c.value, i, o);
                        }
                    ...
                    return (
                      ...
                      (fn.data = function () {
                        var e = { functions: [], options: f.option },
                          ...
                          a,
                          l;
                        fn.errors.length && (e.errors = fn.errors),
                          f.jsonMode && (e.json = !0);
                        for (a in It)
                          r.has(It, a) && t.push({ name: a, line: It[a] });
                        t.length > 0 && (e.implieds = t),
                          Gt.length > 0 && (e.urls = Gt),
                          (l = Object.keys(Jt)),
                          l.length > 0 && (e.globals = l);
                        for (o = 1; o < jt.length; o += 1) {
                          (s = jt[o]), (i = {});
                          for (u = 0; u < Ht.length; u += 1) i[Ht[u]] = [];
                          for (u = 0; u < Ht.length; u += 1)
                            i[Ht[u]].length === 0 && delete i[Ht[u]];
                          (i.name = s["(name)"]),
                            (i.param = s["(params)"]),
                            (i.line = s["(line)"]),
            ...
            5: [
              function (e, t, n) {
                ...
                var s = e("underscore"),
                  ...
                  l = [
                    170, 170, 181, 181, 186, 186, 192, 214, 216, 246, 248, 705,
                    710, 721, 736, 740, 748, 748, 750, 750, 880, 884, 886, 887,
                    890, 893, 902, 902, 904, 906, 908, 908, 910, 929, 931, 1013,
                    1015, 1153, 1162, 1319, 1329, 1366, 1369, 1369, 1377, 1415,
                    ...
                    2088, 2088, 2112, 2136, 2308, 2361, 2365, 2365, 2384, 2384,
                    2392, 2401, 2417, 2423, 2425, 2431, 2437, 2444, 2447, 2448,
                    ...
                    2749, 2749, 2768, 2768, 2784, 2785, 2821, 2828, 2831, 2832,
                    ...
                    3086, 3088, 3090, 3112, 3114, 3123, 3125, 3129, 3133, 3133,
                    3160, 3161, 3168, 3169, 3205, 3212, 3214, 3216, 3218, 3240,
                    3242, 3251, 3253, 3257, 3261, 3261, 3294, 3294, 3296, 3297,
                    3313, 3314, 3333, 3340, 3342, 3344, 3346, 3386, 3389, 3389,
                    3406, 3406, 3424, 3425, 3450, 3455, 3461, 3478, 3482, 3505,
                    ...
                    3913, 3948, 3976, 3980, 4096, 4138, 4159, 4159, 4176, 4181,
                    ...
                    5792, 5866, 5870, 5872, 5888, 5900, 5902, 5905, 5920, 5937,
                    5952, 5969, 5984, 5996, 5998, 6e3, 6016, 6067, 6103, 6103,
                    6108, 6108, 6176, 6263, 6272, 6312, 6314, 6314, 6320, 6389,
                    6400, 6428, 6480, 6509, 6512, 6516, 6528, 6571, 6593, 6599,
                    6656, 6678, 6688, 6740, 6823, 6823, 6917, 6963, 6981, 6987,
                    7043, 7072, 7086, 7087, 7104, 7141, 7168, 7203, 7245, 7247,
                    7258, 7293, 7401, 7404, 7406, 7409, 7424, 7615, 7680, 7957,
                    ...
                    8495, 8505, 8508, 8511, 8517, 8521, 8526, 8526, 8544, 8584,
                    11264, 11310, 11312, 11358, 11360, 11492, 11499, 11502,
                    11520, 11557, 11568, 11621, 11631, 11631, 11648, 11670,
                    ...
                    12784, 12799, 13312, 13312, 19893, 19893, 19968, 19968,
                    40907, 40907, 40960, 42124, 42192, 42237, 42240, 42508,
                    42512, 42527, 42538, 42539, 42560, 42606, 42623, 42647,
                    42656, 42735, 42775, 42783, 42786, 42888, 42891, 42894,
                    42896, 42897, 42912, 42921, 43002, 43009, 43011, 43013,
                    43015, 43018, 43020, 43042, 43072, 43123, 43138, 43187,
                    43250, 43255, 43259, 43259, 43274, 43301, 43312, 43334,
                    43360, 43388, 43396, 43442, 43471, 43471, 43520, 43560,
                    43584, 43586, 43588, 43595, 43616, 43638, 43642, 43642,
                    43648, 43695, 43697, 43697, 43701, 43702, 43705, 43709,
                    43712, 43712, 43714, 43714, 43739, 43741, 43777, 43782,
                    43785, 43790, 43793, 43798, 43808, 43814, 43816, 43822,
                    43968, 44002, 44032, 44032, 55203, 55203, 55216, 55238,
                    ...
                    66208, 66256, 66304, 66334, 66352, 66378, 66432, 66461,
                    66464, 66499, 66504, 66511, 66513, 66517, 66560, 66717,
                    67584, 67589, 67592, 67592, 67594, 67637, 67639, 67640,
                    67644, 67644, 67647, 67669, 67840, 67861, 67872, 67897,
                    68096, 68096, 68112, 68115, 68117, 68119, 68121, 68147,
                    68192, 68220, 68352, 68405, 68416, 68437, 68448, 68466,
                    68608, 68680, 69635, 69687, 69763, 69807, 73728, 74606,
                    74752, 74850, 77824, 78894, 92160, 92728, 110592, 110593,
                    119808, 119892, 119894, 119964, 119966, 119967, 119970,
                    119970, 119973, 119974, 119977, 119980, 119982, 119993,
                    119995, 119995, 119997, 120003, 120005, 120069, 120071,
                    120074, 120077, 120084, 120086, 120092, 120094, 120121,
                    120123, 120126, 120128, 120132, 120134, 120134, 120138,
                    120144, 120146, 120485, 120488, 120512, 120514, 120538,
                    120540, 120570, 120572, 120596, 120598, 120628, 120630,
                    120654, 120656, 120686, 120688, 120712, 120714, 120744,
                    120746, 120770, 120772, 120779, 131072, 131072, 173782,
                    173782, 173824, 173824, 177972, 177972, 177984, 177984,
                    178205, 178205, 194560, 195101,
                  ],
                  c = [];
                for (var h = 0; h < 128; h++)
                  c[h] =
                ...
                (i.prototype = {
                  ...
                  scanPunctuator() {
                    ...
                    switch (e) {
                      case ".":
                        ...
                        if (this.peek(1) === "." && this.peek(2) === ".")
                          return { type: f.Punctuator, value: "..." };
                      case "(":
                      case ")":
                      case ";":
                      case ",":
                    ...
                    return (
                      ...
                      e === ">" && t === ">" && n === ">" && r === "="
                        ...
                        ? { type: f.Punctuator, value: ">>=" }
                        : e === "=" && t === ">"
                        ? { type: f.Punctuator, value: e + t }
                        : e === t && "+-<>&|".indexOf(e) >= 0
                        ? { type: f.Punctuator, value: e + t }
                        : "<>=!+-*%&|^".indexOf(e) >= 0
                        ? t === "="
                          ? { type: f.Punctuator, value: e + t }
                          : { type: f.Punctuator, value: e }
                        : e === "/"
                  ...
                  scanComments() {
                    ...
                    if (n === "/")
                      return this.skip(this.input.length), e("//", r);
                    var o = "";
                    if (n === "*") {
                      this.skip(2);
                    ...
                    var n = "",
                      ...
                      o = function () {
                        ...
                        var n = this.peek(r + 1),
                          ...
                          o = this.peek(r + 4),
                          u;
                        return t(n) && t(i) && t(s) && t(o)
                          ? ((u = parseInt(n + i + s + o, 16)),
                            e(u) ? ((r += 5), "\\u" + n + i + s + o) : null)
                          : null;
                      }.bind(this),
                      u = function () {
                        var t = this.peek(r),
                        ...
                        switch (o) {
                          ...
                          case "0":
                            ...
                            this.triggerAsync(
                              ...
                              function () {
                                return (
                                  l >= 0 && l <= 7 && a.directive["use strict"]
                                );
                              }
                            );
                            break;
                  ...
                  nextLine() {
                    var e;
                    return this.line >= this.getLines().length
                      ? !1
                      : ((this.input = this.getLines()[this.line]),
                        ...
                        a.option.maxlen &&
                          a.option.maxlen < this.input.length &&
                          this.trigger("warning", {
                            code: "W101",
                            line: this.line,
                  ...
                  token() {
                    ...
                    var t = r(),
                      ...
                      i = function (n, r, i) {
                        ...
                        if (n === "(identifier)") {
                          if (r === "return" || r === "case" || r === "typeof")
                            this.prereg = !0;
                          s.has(a.syntax, r) &&
                            ((o = Object.create(
                              a.syntax[r] || a.syntax["(error)"]
                            )),
                        ...
                        case f.NumericLiteral:
                          return (
                            ...
                            this.triggerAsync(
                              ...
                              function () {
                                return (
                                  a.directive["use strict"] && n.base === 8
                                );
                              }
                            ),
                            this.trigger("Number", {
                ...
                n.register = function (e) {
                  e.on("Identifier", function (t) {
                    ...
                    e.on("Identifier", function (t) {
                      ...
                      if (
                        e.getOption("node") &&
                        /^(__dirname|__filename)$/.test(t.name) &&
                        !t.isProperty
                      )
                        return;
                      /^(_+.*|.*_+)$/.test(t.name) &&
                    ...
                    e.on("String", function (t) {
                      ...
                      n.test(t.value) &&
                        e.warn("W107", { line: t.line, char: t.char });
                    });
                };
              },
              {},
            ...
            10: [
              function (e, t, n) {
                ...
                var s = (n.EventEmitter = i.EventEmitter),
                  o =
