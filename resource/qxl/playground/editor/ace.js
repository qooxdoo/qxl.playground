(function () {
    ...
    r = function (e, t, n) {
      if (Object.prototype.toString.call(t) === "[object Array]") {
        ...
        if (typeof t == "string") {
          var f = s(e, t);
          return !f && r.original
            ? r.original.apply(window, arguments)
            : (n && n(), f);
        }
        ...
        (this.getLineTokens = function (e, t) {
          ...
          while ((a = u.exec(e))) {
            ...
            if (v - d.length > l) {
              ...
              c.type == h
                ? (c.value += m)
                : (c.type && f.push(c), (c = { type: h, value: m }));
            }
            ...
            if (f.length > r) {
              while (l < e.length)
                c.type && f.push(c),
                  (c = { value: e.substring(l, (l += 2e3)), type: "overflow" });
              (i = "start"), (n = []);
              break;
            }
          }
        ...
        (this.findMatchingBracket = function (e, t) {
          ...
          (this.$findOpeningBracket = function (e, t, n) {
            ...
            n ||
              (n = new RegExp(
                "(\\.?" +
                  u.type.replace(".", "\\.").replace("rparen", ".paren") +
                  ")+"
              ));
          ...
          (this.$findClosingBracket = function (e, t, n) {
            ...
            n ||
              (n = new RegExp(
                "(\\.?" +
                  u.type.replace(".", "\\.").replace("lparen", ".paren") +
                  ")+"
              ));
    ...
    function (e, t, n) {
      ...
      (function () {
        ...
        r.implement(this, o),
          ...
          (this.$defaultUndoManager = { undo() {}, redo() {}, reset() {} }),
          ...
          var n = !1,
            r = function () {
              n ||
                ((n = !0),
                console.error(
                  "commmandKeyBinding has too many m's. use commandKeyBinding"
                ));
            };
  ...
  define(
    ...
    ["require", "exports", "module", "ace/lib/lang", "ace/config"],
    function (e, t, n) {
      function s(e, t) {
        return { win: e, mac: t };
      }
    ...
    function (e, t, n) {
      ...
      var m = function (e, t) {
        ...
        (this.canvas = r.element),
          ...
          (this.$fontMetrics = new p(this.container, 500)),
      ...
      (function () {
        (this.CHANGE_CURSOR = 1),
          ...
          (this.$moveTextAreaToCursor = function () {
            ...
            (n -= this.scrollLeft),
              ...
              (this.textarea.style.right =
                Math.max(0, this.$size.scrollerWidth - n - i) + "px"),
              (this.textarea.style.bottom =
                Math.max(0, this.$size.height - t - r) + "px");
          }),
          ...
          (this.$updateScrollBarV = function () {
            this.scrollBarV.setScrollHeight(
              this.layerConfig.maxHeight + this.scrollMargin.v
            ),
          ...
          (this.$computeLayerConfig = function () {
            ...
            f && ((this.$horizScroll = a), this.scrollBarH.setVisible(a)),
              !this.$maxLines &&
                this.$scrollPastEnd &&
                this.scrollTop > i - t.scrollerHeight &&
                (i += Math.min(
            ...
            var l =
                !n &&
                (this.$vScrollBarAlwaysVisible || t.scrollerHeight - i < 0),
              c = this.$vScroll !== l;
            ...
            return (
              (this.layerConfig = {
                ...
                gutterOffset: Math.max(
                  0,
                  Math.ceil((s + t.height - t.scrollerHeight) / g)
                ),
          ...
          (this.isScrollableBy = function (e, t) {
            ...
            if (
              ...
              this.session.getScrollTop() +
                ...
                (this.$size.scrollerHeight - this.lineHeight) *
                  this.$scrollPastEnd <
        ...
        s.defineOptions(m.prototype, "renderer", {
      ...
      function f(r) {
        ...
        for (var f = 0; f < o.length; f++) {
          ...
          for (var d = 0, v = p.length; d < v; d++) {
            var m = p[d];
            m.name.indexOf("data-ace-") === 0 &&
              (i[l(m.name.replace(/^data-ace-/, ""))] = m.value);
          }
              ...
              if (this.displayIndentGuides) {
                ...
                if (this.showInvisibles) {
                  ...
                  var i = s.stringRepeat(this.SPACE_CHAR, this.tabSize),
                    o =
                      this.TAB_CHAR + s.stringRepeat("\xa0", this.tabSize - 1);
                } else
                  var i = s.stringRepeat("\xa0", this.tabSize),
                    o = i;
                (this.$tabStrings[" "] =
                  "<span class='" + r + "'>" + i + "</span>"),
                  (this.$tabStrings["	"] =
          ...
          (this.$renderToken = function (e, t, n, r) {
            var i = this,
              ...
              u = function (e, n, r, o, u) {
                ...
                return r
                  ? "<span class='ace_invisible ace_invalid'>" +
                      i.SPACE_CHAR +
                      "</span>"
                  : ((t += 1),
        ...
        (this.onMouseDown = function (e) {
          ...
          return (
            ...
            !t || this.$clickSelection || e.getShiftKey() || r.inMultiSelectMode
              ? this.startSelect(n)
              : t &&
                ((this.mousedownEvent.time = Date.now()), this.startSelect(n)),
            e.preventDefault()
          );
        }),
          (this.startSelect = function (e) {
            ...
            n
              ...
              : this.$clickSelection || t.selection.moveToPosition(e),
      ...
      var r = e("../lib/oop"),
        ...
        a = (t.FontMetrics = function (e, t) {
          (this.el = i.createElement("div")),
            ...
            (this.$measureNode.textContent = s.stringRepeat("X", u)),
        ...
        r.implement(this, o),
          ...
          (this.$measureSizes = function () {
            var e = this.$measureNode.getBoundingClientRect(),
              t = { height: e.height, width: e.width / u };
              ...
              k && ((e = k(e)), (k = null)),
                c
                  ...
                  : (e.substring(0, 2) == a
                      ...
                      ? (e = e.substr(1))
                      : e.charAt(e.length - 1) == a.charAt(0) &&
                        (e = e.slice(0, -1)),
                    e.charAt(e.length - 1) == a.charAt(0) &&
                      (e = e.slice(0, -1)),
                    e && t.onTextInput(e)),
          ...
          r.addListener(n, "compositionstart", P),
            ...
            (this.onContextMenu = function (e) {
              (L = !0),
                p || (p = n.style.cssText),
                (n.style.cssText =
                  "z-index:100000;" + (i.isIE ? "opacity:0.1;" : "")),
      ...
      (function () {
          ...
          (this.forEachSelection = function (e, t, n) {
            ...
            for (var l = o.ranges.length; l--; ) {
              if (n)
                while (
                  l > 0 &&
                  o.ranges[l].start.row == o.ranges[l - 1].end.row
                )
                  l--;
              f.fromOrientedRange(o.ranges[l]),
                (f.id = o.ranges[l].marker),
          ...
          (this.alignCursors = function () {
            ...
            if (!n.length) {
              ...
              (c = this.$reAlignText(c, u)),
                ...
                u ||
                  ((r.start.column = 0),
                  (r.end.column = c[c.length - 1].length)),
        ...
        (t.onSessionChange = function (e) {
          ...
          n &&
            ...
            n.multiSelect.removeEventListener(
              "removeRange",
              this.$onRemoveRange
            ),
            n.multiSelect.removeEventListener(
              ...
              this.commands.on(
                ...
                function (t) {
                  ...
                  if (n.aceCommandGroup == "fileJump") {
                    var r = this.prevOp;
                    if (!r || r.command.aceCommandGroup != "fileJump")
          ...
          (this.$highlightBrackets = function () {
            ...
            (this.$highlightPending = !0),
              setTimeout(function () {
                ...
                n &&
                  (e.session.$bracketHighlight = e.session.addMarker(
                    n,
                    "ace_bracket",
                    "text"
                  ));
          ...
          (this.jumpToMatching = function (e) {
            ...
            if (!n) {
              n = this.find({
                needle: /[{}()\[\]]/g,
                preventScroll: !0,
                start: { row: t.row, column: t.column - 1 },
              });
              if (!n) return;
              var r = n.start;
              r.row == t.row &&
                Math.abs(r.column - t.column) < 2 &&
          ...
          a.$blockScrolling++,
            a.once("mouseup", function () {
              ...
              S && e.isEmpty() && i(S.cursor, e.cursor)
                ...
                : (E && (a.removeSelectionMarker(E), f.addRange(E)),
                  f.addRange(e)),
                a.$blockScrolling--;
            });
        } else if (n && u === 0) {
